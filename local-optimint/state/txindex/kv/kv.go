...
func (txi *TxIndex) Search(ctx context.Context, q *query.Query) ([]*abci.TxResult, error) {
	fmt.Print("[optimint] txinder/kv/kv.go Search\n")
	fmt.Printf("Query: %#v\n", q)
	...
	fmt.Printf("[optimint] kv.go conditions: %#v\n", conditions)
	...
	fmt.Printf("[optimint] kv.go hash: %#v\n", hash)
	fmt.Print("[optimint] kv.go Search.lookForHash passed\n")
	...
	fmt.Print("[optimint] kv.go Search.indexer.LookForRanges passed\n")

	// if there is a height condition ("tx.height=3"), extract it
	height := lookForHeight(conditions)

	fmt.Printf("[optimint] kv.go height: %#v\n", height)
	fmt.Print("[optimint] kv.go Search.lookForHeight passed\n")
	...
	fmt.Printf("[optimint] kv.go results: %#v\n", results)
	fmt.Print("[optimint] kv.go Search passed\n")
